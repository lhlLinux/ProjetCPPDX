...
Ceci est une simple démo attestant mes aptitudes en C++, dans un environnement d'un système d'exploitation, ainsi que l'usage d'API.

![Capture d'écran](dxdemo01.png "screenshot")
...
- DirectX9
- C++
- Développé avec DevC++ v5.11 (pour sa légèreté et simplicité) 
